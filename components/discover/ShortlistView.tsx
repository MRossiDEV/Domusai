  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col" style={{ background: "var(--weeggo-paper-dim)" }}>
      <div className="min-h-0 flex-1 overflow-y-auto px-[18px] pt-[18px] pb-[18px]">
        <div className="mb-0.5 text-[23px] font-extrabold">Your shortlist</div>

        {items.length === 0 ? (
          <div className="text-[12.5px] text-muted-foreground">
            Nothing yet — swipe right on places you like in Discover.
          </div>
        ) : (
          <>
            <div className="mb-4 text-[12.5px] text-muted-foreground">
              Places you&apos;ve liked. Tap up to 3 to compare.
            </div>
